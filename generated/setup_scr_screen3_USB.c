...
void setup_scr_screen3_USB(lv_ui *ui){
	...
	lv_obj_set_pos(ui->screen3_USB_left_btn, 10, 10);
	lv_obj_set_size(ui->screen3_USB_left_btn, 150, 150);
	lv_imgbtn_set_src(ui->screen3_USB_left_btn,LV_BTN_STATE_RELEASED,&_left_arrow_alpha_150x150);
	lv_imgbtn_set_src(ui->screen3_USB_left_btn,LV_BTN_STATE_PRESSED,&_left_arrow_dark_alpha_150x150);

	//Write codes screen3_USB_left_label
	ui->screen3_USB_left_label = lv_label_create(ui->screen3_USB, NULL);
	lv_label_set_text(ui->screen3_USB_left_label, "MENU");
	...
	lv_style_set_text_color(&style_screen3_USB_left_label_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_font(&style_screen3_USB_left_label_main, LV_STATE_DEFAULT, &lv_font_simsun_48);
	...
	lv_obj_set_pos(ui->screen3_USB_left_label, 0, 160);
	...
	lv_obj_set_pos(ui->screen3_USB_avlogoimg0, 272, 20);
	lv_obj_set_size(ui->screen3_USB_avlogoimg0, 176, 176);
	lv_obj_set_click(ui->screen3_USB_avlogoimg0, true);
	lv_img_set_src(ui->screen3_USB_avlogoimg0,&_AvnetIcon310x310_alpha_176x176);
	...
	lv_obj_set_pos(ui->screen3_USB_right_btn, 560, 10);
	lv_obj_set_size(ui->screen3_USB_right_btn, 150, 150);
	lv_imgbtn_set_src(ui->screen3_USB_right_btn,LV_BTN_STATE_RELEASED,&_right_arrow_alpha_150x150);
	lv_imgbtn_set_src(ui->screen3_USB_right_btn,LV_BTN_STATE_PRESSED,&_right_arrow_dark_alpha_150x150);
	...
	lv_style_set_text_color(&style_screen3_USB_right_label_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_font(&style_screen3_USB_right_label_main, LV_STATE_DEFAULT, &lv_font_simsun_48);
	...
	lv_obj_set_pos(ui->screen3_USB_right_label, 540, 160);
	lv_obj_set_size(ui->screen3_USB_right_label, 180, 0);

	//Write codes screen3_USB_img_5oodt29s
	ui->screen3_USB_img_5oodt29s = lv_img_create(ui->screen3_USB, NULL);

	//Write style LV_IMG_PART_MAIN for screen3_USB_img_5oodt29s
	static lv_style_t style_screen3_USB_img_5oodt29s_main;
	lv_style_init(&style_screen3_USB_img_5oodt29s_main);

	//Write style state: LV_STATE_DEFAULT for style_screen3_USB_img_5oodt29s_main
	lv_style_set_image_recolor(&style_screen3_USB_img_5oodt29s_main, LV_STATE_DEFAULT, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_image_recolor_opa(&style_screen3_USB_img_5oodt29s_main, LV_STATE_DEFAULT, 0);
	lv_style_set_image_opa(&style_screen3_USB_img_5oodt29s_main, LV_STATE_DEFAULT, 255);
	lv_obj_add_style(ui->screen3_USB_img_5oodt29s, LV_IMG_PART_MAIN, &style_screen3_USB_img_5oodt29s_main);
	lv_obj_set_pos(ui->screen3_USB_img_5oodt29s, 102, 480);
	lv_obj_set_size(ui->screen3_USB_img_5oodt29s, 512, 512);
	lv_obj_set_click(ui->screen3_USB_img_5oodt29s, true);
	lv_img_set_src(ui->screen3_USB_img_5oodt29s,&_USB_alpha_512x512);
	lv_img_set_pivot(ui->screen3_USB_img_5oodt29s, 0,0);
	lv_img_set_angle(ui->screen3_USB_img_5oodt29s, 0);
